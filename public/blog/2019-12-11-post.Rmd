...
```
  <p style="color:#1e6330">Here, I generated a logistic regression with marginal adhesion as the explanatory variable and benign/malignancy as the response. This is telling us that every 1 unit increase in marginal adhesion, the odds of malignancy are multiplied by a factor of 2.62689515. 
